        ...
        kdump_attr = \
            {"kdumptool_flags": lambda val: val in ["NOSPARSE",
             ...
             "kdump_dumpformat": lambda val: val in ["ELF",
                                                     ...
                                                     "sanppy",
                                                     ""],
             "kdump_copy_kernel": lambda val: val in ["yes", "no", "true", "false"],
             "kdump_immediate_reboot": lambda val: val in ["yes", "no", "true", "false"],
             "kdump_verbose": lambda val: int(val) > -1 and int(val) < 32,
             "kdump_continue_on_error": lambda val: val in ["true", "false"],
             "kdump_fadump": lambda val: val in ["no", "false"],
             "kdump_fadump_shell": lambda val: val in ["no", "false"],
